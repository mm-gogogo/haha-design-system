/**
 * 🌿 Mineral · 矿物康养编辑风 Tailwind 预设
 * 全部消费 tokens.css 里的 CSS 变量（--ds-*），所以亮/暗主题自动跟随。
 * 用法：
 *   // tailwind.config.js
 *   module.exports = { presets: [require('./styles/18-mineral-editorial/tailwind.preset.js')] }
 *   // 并在入口引入 tokens.css
 *   import './styles/18-mineral-editorial/tokens.css'
 *
 * 提示：本风格主轴是「衬线大标题 + 人文无衬线正文/UI」。
 *   大标题/封面用 font-serif；正文、控件、元信息用 font-sans；小标/eyebrow 偶用 font-mono。
 *   编辑容器建议 max-w-[680px]，正文配 leading-relaxed；分层靠细线与留白，阴影极柔。
 */
module.exports = {
  theme: {
    extend: {
      ...
      fontFamily: {
        // 大标题/封面：衬线（Noto Serif，气质担当）
        serif: 'var(--ds-font-serif)',
        // 正文/控件/元信息：人文无衬线（Inter）
        sans: 'var(--ds-font-sans)',
        // 小标 eyebrow / 数字 / 引用代码：等宽
      ...
      // 编辑容器宽度（mineral-editorial 核心：约 40rem/680px）
      maxWidth: {
        reading: '680px',
        prose: '680px',
      },
