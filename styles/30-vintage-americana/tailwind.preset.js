/**
 * Vintage Americana / 复古美式 Tailwind preset
 * Consumes tokens.css CSS variables (--ds-*), so light and dark themes follow
 * [data-theme="dark"] or .dark without duplicating component colors.
 *
 * Usage:
 *   // tailwind.config.js
 *   module.exports = { presets: [require('./styles/30-vintage-americana/tailwind.preset.js')] }
 *   // Import the tokens once in the app entry:
 *   import './styles/30-vintage-americana/tokens.css'
 *
 * Style notes:
 * - Use font-serif for bold diner/signage headlines.
 * - Use font-sans with uppercase and wide tracking for labels, nav, tickets.
 * - Use gold only as a decorative extension for starbursts, seals, pinstripes.
 */
module.exports = {
  theme: {
    extend: {
