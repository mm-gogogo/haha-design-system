/**
 * 复古音响 · Hi-Fi / Vintage Audio Tailwind preset
 * Consumes tokens.css CSS variables (--ds-*), so the champagne daylight
 * faceplate and walnut graphite night console follow the runtime theme.
 *
 * Usage:
 *   // tailwind.config.js
 *   module.exports = { presets: [require('./styles/49-hifi/tailwind.preset.js')] }
 *   // import tokens.css in your app entry
 *   import './styles/49-hifi/tokens.css'
 *
 *   <button class="bg-primary text-primary-fg rounded-sm shadow-md
 *                  transition duration-base ease-ds">Power</button>
