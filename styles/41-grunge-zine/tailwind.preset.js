/**
 * Grunge / Zine Photocopy Punk — Tailwind Preset
 * ---------------------------------------------------------------------------
 * Maps the fixed --ds-* CSS variable contract. Import tokens.css in the app,
 * then use `presets: [require('./tailwind.preset.js')]`.
 *
 * Identity notes: square paper cuts, ink borders, hard offset shadows, safety
 * orange primary actions, highlighter-pink accents, and dark-theme ink reversal.
 */
module.exports = {
