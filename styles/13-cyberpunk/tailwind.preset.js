/**
 * Cyberpunk / 赛博朋克风 — Tailwind Preset
 * ---------------------------------------------------------------------------
 ...
 *
 * 赛博朋克气质要点：
 *   - radius 极小（sm2 / md6 / lg10），霓虹硬朗。
 *   - shadow 叠霓虹辉光（见 tokens.css）。
 *   - boxShadow.glow / glow-accent / glow-warning 提供霓虹发光工具类。
 *   - display 走 mono；动效利落 150–260ms。
 */
module.exports = {
