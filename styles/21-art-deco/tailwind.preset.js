/**
 * 装饰艺术 / Art Deco · Tailwind 预设
 * 全部消费 tokens.css 里的 CSS 变量（--ds-*），所以亮/暗主题自动跟随。
 * 用法：
 *   // tailwind.config.js
 *   module.exports = { presets: [require('./styles/21-art-deco/tailwind.preset.js')] }
 *   // 并在入口引入 tokens.css
 *   import './styles/21-art-deco/tokens.css'
 *
 * 提示：本风格主轴是「衬线大标题 + 宽字距大写小标 + 无衬线正文」。
 *   大标题用 font-serif（Noto Serif），小标/字号标签用 font-sans 大写宽字距，正文/控件用 font-sans。
 *   深祖母绿 primary 作主操作，金 accent 作链接/次强调与饰线（太阳放射/人字/双金线）。
 */
module.exports = {
  theme: {
    extend: {
