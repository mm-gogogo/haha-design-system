/**
 * Skeuomorphism · 拟物写实 (Rich Skeuo) Tailwind preset
 * Consumes tokens.css CSS variables (--ds-*), so light/dark themes follow the runtime theme.
 * Includes tactile elevation shadows plus inset shadows for beveled inputs, pressed gel buttons,
 * stitched panels, and brushed-metal controls.
 *
 * Usage:
 *   // tailwind.config.js
 *   module.exports = { presets: [require('./styles/32-skeuomorphism/tailwind.preset.js')] }
 ...
 *                  transition duration-base ease-ds">Gloss button</button>
