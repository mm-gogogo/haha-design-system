/**
 * 票据印章 · Ticketing / Pass & Postal Tailwind preset
 * Values consume tokens.css CSS variables (--ds-*), so light/dark themes
 * follow [data-theme="dark"] or .dark automatically.
 *
 * Usage:
 *   // tailwind.config.js
 *   module.exports = { presets: [require('./styles/47-ticket/tailwind.preset.js')] }
 *   // and import tokens.css in your app entry
 *   import './styles/47-ticket/tokens.css'
 *
 * This style is a fictional authority system for Loop Transit & Post:
 * use font-sans for labels and controls, font-mono for serials, dates,
 * gates, zones, coupons, and barcodes, and font-serif for seals and
