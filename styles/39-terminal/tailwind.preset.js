/**
 * Terminal / TUI 终端绿磷 — Tailwind Preset
 * ---------------------------------------------------------------------------
 * 全量映射 --ds-* CSS 变量。先在入口引入 tokens.css（提供 :root 暗色基底 +
 * [data-theme="light"]/.light 亮色覆盖），再在 tailwind.config.js 里：
 *   presets: [require('./tailwind.preset.js')]
 *
 * 本风格暗色优先：:root 即 phosphor CRT，亮色靠 [data-theme="light"] / .light 覆盖。
 * 关键气质：全等宽、0px 圆角、1px 硬描边、绿磷 glow、琥珀 ANSI 次强调。
 */
module.exports = {
  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'glow-amber': '0 0 18px -2px var(--ds-accent)',
      },
