/**
 * 天文星图 · Celestial Star-Atlas — Tailwind Preset
 * ---------------------------------------------------------------------------
 * 全量映射 --ds-* CSS 变量。先在入口引入 tokens.css（提供 :root 暗色基底 +
 * [data-theme="light"]/.light 亮色覆盖），再在 tailwind.config.js 里：
 *   presets: [require('./tailwind.preset.js')]
 *
 * 暗色优先：:root 即深夜星图，亮色靠 [data-theme="light"] / .light 覆盖。
 *
 * 风格要点：
 *   - radius 锐利（sm3/md6/lg10/full999），像铜版星图的纸面切线。
 *   - shadow 是 crisp hairline 与轻微压痕，不提供发光工具类。
 *   - serif 用于展示标题和拉丁星座名；mono 用于 RA/Dec、星等与编号。
 *   - motion 克制，装饰性星点闪烁应在 reduced-motion 下关闭。
 */
module.exports = {
  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        hairline: '0 0 0 1px var(--ds-border)',
        'hairline-strong': '0 0 0 1px var(--ds-border-strong)',
      },
