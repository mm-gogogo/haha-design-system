/**
 * Dark Academia · 暗黑学院风 Tailwind 预设
 * 全部消费 tokens.css 里的 CSS 变量（--ds-*），所以亮/暗主题自动跟随。
 * 用法：
 *   // tailwind.config.js
 *   module.exports = { presets: [require('./styles/34-dark-academia/tailwind.preset.js')] }
 *   // 并在入口引入 tokens.css
 *   import './styles/34-dark-academia/tokens.css'
 *
 * 提示：本风格主轴是「衬线阅读 + 无衬线 UI + 等宽脚注/目录号」。
 *   正文/标题用 font-serif，控件/小型标签用 font-sans，脚注号/目录号用 font-mono。
 *   阅读容器建议 max-w-reading；装饰 brass 仅用于规则线、印章、书签和边框。
 */
module.exports = {
  theme: {
    extend: {
      ...
      // Reading and archive layouts: article column + marginalia.
      maxWidth: {
        reading: '680px',
        prose: '680px',
      },
