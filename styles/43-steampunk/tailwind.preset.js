/**
 * 蒸汽朋克 / Steampunk · Tailwind 预设
 * 全部消费 tokens.css 里的 CSS 变量（--ds-*），所以亮/暗主题自动跟随。
 * 用法：
 *   // tailwind.config.js
 *   module.exports = { presets: [require('./styles/43-steampunk/tailwind.preset.js')] }
 *   // 并在入口引入 tokens.css
 *   import './styles/43-steampunk/tokens.css'
 *
 * 提示：本风格主轴是「维多利亚衬线标题 + 无衬线正文 + 等宽仪表读数」。
 *   黄铜 primary 承担主操作与铆钉金属板；铜绿 accent 承担链接、压力表针、
 *   氧化铜细节与状态强调。暗色 primary/accent 有意配深字以达 AA。
 */
module.exports = {
  theme: {
    extend: {
