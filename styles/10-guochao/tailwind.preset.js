/**
 * 国潮 / 新中式 Guochao · Tailwind 预设
 * 全部消费 tokens.css 里的 CSS 变量（--ds-*），所以亮/暗主题自动跟随。
 * 用法：
 *   // tailwind.config.js
 *   module.exports = { presets: [require('./styles/10-guochao/tailwind.preset.js')] }
 *   // 并在入口引入 tokens.css
 *   import './styles/10-guochao/tokens.css'
 *
 * 提示：本风格主轴是「衬线标题 + 无衬线正文」。
 *   标题用 font-serif（思源宋/Songti 回退），正文/控件用 font-sans。
 *   朱红 primary 作主操作，靛蓝 accent 作链接/次强调，gold 仅作细描边/印章点缀。
 */
module.exports = {
  theme: {
    extend: {
