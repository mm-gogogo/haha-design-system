...
与 aibacknovel（同基底的「文学暖纸」赭橙风）**明显区别**：那边是暖纸 + 衬线正文 + 赭橙文学调；这边是冷白干净底 + 无衬线产品正文 + 开源绿/青，更轻、更产品、更开源。
...
- 浓「文学/书卷」气质的纯阅读站（那是 editorial/aibacknovel 的活）
...
**Don't**
- 别回退成暖纸 + 衬线正文（那是 editorial/aibacknovel 的脸，会撞）。
