/**
 * XiunoNext · xiunobbs 论坛 Tailwind Preset
 * ---------------------------------------------------------------
 * 基于「企业风」+ xiunobbs 定制（清爽现代论坛社区 · 社区蓝）。
 * 消费 tokens.css 暴露的 CSS 变量（--ds-*）。
 * 颜色一律走变量 → 亮/暗主题随 [data-theme="dark"] / .dark 自动切换，无需重配 Tailwind。
 *
 * 用法（Inertia 2 + React 19 + Vite + Tailwind 4 默认栈，见 SPEC §3.6）：
 *   // tailwind.config.js
 *   module.exports = {
 ...
 * SPEC 要求暗色模式完整：prefers-color-scheme + 手动切换皆可。
 */
module.exports = {
